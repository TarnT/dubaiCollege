...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            remove_symbol = input("Would you like to remove a cell (y/n): ")
            ...
            if remove_symbol.lower() == "y":
                CurrentCell = self.__GetCell(Row, Column)

                if CurrentCell.IsEmpty() or CurrentCell.GetSymbol() == "@" or not CurrentCell.CheckSymbolAllowed(CurrentCell.GetSymbol()):
                    print("Invalid cell for one of several reasons")
                else:
